...
A crucial part of cell biology is the process of signaling - which is the cells' ways of communication with themselves and the environment - yet it remains relatively poorly understood. Disturbances in these processes can lead, for example, to disorders in cells growth and development, physiological regulation, the life cycle of the cell - causing excessive proliferation or prolonged life - and many others, thus it's no surprise that we are observing them accompanying many health problems like ...(tutaj żeby nie palnąć głupoty jakieś artykuły potwierdzające poszczególne problemy do zerknięcia).

In this project we aim to give a better understanding of ACT/ERK collective activity waves which have been shown to be able to drive apoptosis-induced survival and are suspected to play relevant role in cancer development. We were presented ....(opis danych). 
