...
In this project we aim to give a better understanding of ACT/ERK collective activity waves which have been shown to have ability to drive apoptosis-induced survival and are suspected to play relevant role in cancer development. We were presented ....(opis danych). 
